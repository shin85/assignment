...
--
-- Database: malaga
-- Generation Time: 2021-09-09 15:38:56.8810
-- -------------------------------------------------------------
...
CREATE TABLE `book` (
  ...
  PRIMARY KEY (`id`),
  KEY `book_category_id_fk` (`category`),
  CONSTRAINT `book_category_id_fk` FOREIGN KEY (`category`) REFERENCES `category` (`id`)
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_organization1_idx` (`idOrganization`),
  CONSTRAINT `fk_user_organization1` FOREIGN KEY (`idOrganization`) REFERENCES `organization` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8;

INSERT INTO `book` (`id`, `title`, `des`, `image`, `category`) VALUES
(2, 'sjkahdkfasjhdf', 'skjahfkasjhdf', NULL, 1),
(3, 'asdfasjhdf98', '123123', NULL, 1),
(4, '1232abc', '123abc', NULL, NULL),
(5, '1232abc', '123abc', NULL, NULL),
(6, '1232abc', '123abc', NULL, 2);
