 ...
 */
/**
 * @route("path"=>"/categories/","inherited"=>false,"automated"=>false,"requirements"=>[],"priority"=>0)
 */
class RestCategoryController extends \Ubiquity\controllers\rest\RestResourceController {
